...
ka_b_iv = check_contract(contract(), vacuity_mode=VMODE, refine="affine")
...
t0 = time.perf_counter()
ka_b = check_contract(contract(), vacuity_mode=VMODE, solver_timeout_ms=TIMEOUT_MS, refine="affine")
