...
def gen():
    ...
    # REUSE-IgnoreStart
    # These two are the header the GENERATED file carries, not this file's
    # own licensing statement. Left bare, `reuse lint` reads the trailing
    # `")` as part of the expression and reports the whole repository
    # non-compliant -- measured on the merge, at reuse 6.2.0.
