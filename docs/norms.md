...
Nothing here is style. Every one of them exists because something was measured
wrong, shipped wrong, or claimed without evidence, and the instance is named so
you can check the rule against the thing that produced it rather than taking it
on trust. Several are the reason a verdict from this tool is worth anything.

The numbers in them are as of when they were written.
