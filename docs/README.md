...
| [The overflow tripwire](overflow-tripwire.md) | one line in `conftest.py`: find the integer constants JAX silently narrows in your own traced code, and read exactly which doors it does not watch |
