...
CONTROLS = (
    ...
    Control(
        ...
        why=(
            ...
            "admits. Measured over 1500 examples: 563 violations, 95 of them "
            "an obligation whose box says `definitely true for all elements` "
            "executing FALSE, and 0 of them proved to be a box wrong about "
            "the reals. OPEN — "
