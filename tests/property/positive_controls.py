...
CONTROLS = (
    ...
    Control(
        ...
        why=(
            ...
            "Today's flat property fails there in about a second at the ci "
            "profile (0.4 s to 1.2 s across runs, junit XML), on "
    ...
    Control(
        ...
        why=(
            ...
            "slowest of the three flat-leg controls: 5.6 s best of three, 9.1 "
            "s worst, from junit XML on a box doing other work — the 2.0 s "
            "recorded when this entry landed did not reproduce. A MUTANT, "
