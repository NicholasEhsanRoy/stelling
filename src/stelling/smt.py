    ...
    **``q`` IS EVEN, ALWAYS, AND THE ODD ARM IS A REFUSAL RATHER THAN A
    ...
    if q % 2:
        raise ValueError(
            ...
            f"computes out of the two an even q admits; a denominator that "
            f"is not even would need a different guard entirely, and no test "
            f"in this tree drives that path. Every binary64 exponent is "
            f"dyadic so this is unreachable, and admission "
