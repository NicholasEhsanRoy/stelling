...
def render_rows(width: int) -> str:
    ...
    out.extend([
        ...
        "UNSTATED. Two sweeps, both committed under",
        "`scratchpad/D7-solver-battery/` with the load average in their",
        "header. That directory is tracked and is NOT IN THE SDIST, so if",
        "you are reading this from an unpacked tarball you cannot open",
        "either of them: what you have instead is this file, which prints",
        "the grade they decided, and tests/test_solver_battery.py, which",
        "holds the page and this tool to one another. The figures below",
        "are a historical measurement of the machines named beside them.",
        "",
